...
<head>
<meta charset="utf-8">
<title>Nilai Mata Kuliah Mahasiswa</title>
<style>
body { font-family: sans-serif; margin: 15px; font-size: 12px; }
    ...
    <table class="content-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $mhs->MhswID }}</td>
                <td>{{ $mhs->Nama }}</td>
                <td style="text-align: center;">{{ $mhs->NilaiAkhir }}</td>
                <td style="text-align: center;">{{ $mhs->Grade }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="5" style="text-align: center;">Tidak ada data nilai mahasiswa.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
